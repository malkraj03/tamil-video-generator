"""
Cloud Scheduler Integration - Google Cloud Run compatible
Handles video generation triggered by Cloud Scheduler
"""
...
class CloudVideoGenerator:
    """Generate videos in cloud environment"""
    
    def __init__(self, config: Dict):
        """
        Initialize Cloud Video Generator
        ...
        logger.info("Cloud Video Generator initialized")
    ...
    def generate_and_publish(self) -> Dict:
        """
        Generate and publish video (Cloud Run entry point)
    ...
    def cleanup_old_files(self, days: int = 14) -> Dict:
        """
...
def cleanup_handler(request):
    ...
    try:
        ...
        generator = CloudVideoGenerator(config)
        result = generator.cleanup_old_files(days=14)
